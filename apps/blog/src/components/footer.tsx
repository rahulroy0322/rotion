...
import { BellRingingIcon, DiscordLogoIcon, EnvelopeIcon, FacebookLogoIcon, RedditLogoIcon, XLogoIcon, LinkedinLogoIcon } from '@phosphor-icons/react'
    ...
    <footer className="p-2 container mx-auto space-y-6">
        <nav className="text-muted-foreground gap-4 grid md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-2">
                <Link to='/' className="text-foreground block">
                    <LogoText />
                </Link>
                <h4 className="text-balance">
                    My Mission is to tech every person about JS/TS and web tech may be from zero to hero.
                </h4>
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <a href='mailto:rahulroyapd80@gmail.com'
                    className="flex items-center gap-1"
                >
                    Contact<EnvelopeIcon className="size-4 rotate-45" />
                </a>
                <Link to='.'>
                    Request
                </Link>
            ...
            <div className="flex flex-col gap-2 text-foreground">
                <h3 className="text-xl font-bold flex items-center gap-1 group/noti">
                    Get Notified <BellRingingIcon className="size-4 group-hover/noti:-rotate-45 transition-transform" />
                </h3>
