...
type CarouselIndicatorsPropsType = ComponentProps<'div'>

const CarouselIndicators: FC<CarouselIndicatorsPropsType> = ({
  className,
  ...props
}) => {
  'use no memo'
      ...
      {Array.from(
        ...
        (_, i) => (
          <button
            ...
            className={cn('size-4 rounded-full border border-primary', {
              'bg-primary border-0 ': currentSlide === i,
            })}
            key={i.toString()}
